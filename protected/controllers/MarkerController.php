...
class MarkerController extends Controller
{
	...
	public function actionIndex()
	{
		...
		if(isset($_GET['marker_type']))
		{
			$marker_type=$_GET['marker_type'];
			if($marker_type=='user_created')
			{
				$user=User::model()->findByAttributes(array('username'=>Yii::app()->user->getId()));
				$criteria=new CDbCriteria();
				$criteria->condition='create_user_id=:createUserId';
				$criteria->params=array(':createUserId'=>$user->id);
	...
	{
		$model=Marker::model()->findByPk((int)$id);
		if($model===null)
